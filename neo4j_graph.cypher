// Create constraints for node properties
...
// Add members to the group with unique membershipIDs
...
// Singleton constraint: A person can only live in one place
